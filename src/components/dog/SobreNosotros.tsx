    ...
    <section className="border-t border-line py-24" id="sobre-nosotros">
      <div className="mx-auto max-w-[1180px] px-8">
        <div className="grid grid-cols-1 items-center gap-14 md:grid-cols-2">
          <div className="reveal relative aspect-[3/2] overflow-hidden rounded-sm border border-line md:order-2">
            <Image
          ...
          <div className="reveal md:order-1">
            ...
            <h2 className="mb-6 font-display text-[30px] font-[450] md:text-[42px]">
